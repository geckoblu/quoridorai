...
public class LoadLastAction extends AbstractAction {

    private final Component _parent;
    private final GameModel _gameModel;
    private final GamePanel _gamePanel;

    public LoadLastAction(Component parent, GameModel gameModel, GamePanel gamePanel) {
        super();

        I18N.Action action = I18N.getAction("LOAD_LAST");
